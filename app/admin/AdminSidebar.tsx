...
import { approveSubmission, deleteJob } from "@/server/actions/admin.action";
...
export const ApproveSubmissionButton = ({ jobId }: AdminButtonProps) => {
...
export const DeleteJobButton = ({ jobId }: AdminButtonProps) => {
